...
def main():
    ...
    while True:
        ...
        try:
            ...
            file_path = get_requested_filename(request_line)
...
def get_file_type(file_path):
    ...
    if file_path.endswith(".html"): return ".html"
    if file_path.endswith(".jpeg"): return ".jpeg"
    if file_path.endswith(".ico"): return ".ico"
    if file_path.endswith(".js"): return ".js"
    if file_path.endswith(".css"): return ".css"
